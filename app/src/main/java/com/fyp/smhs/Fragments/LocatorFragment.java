...
import com.fyp.smhs.Activities.DirectionActivity;
import com.fyp.smhs.Adapters.GooglePlaceAdapter;
import com.fyp.smhs.Adapters.InfoWindowAdapter;
...
import com.fyp.smhs.PlaceModel;
import com.fyp.smhs.R;
import com.fyp.smhs.SavedPlaceModel;
import com.fyp.smhs.Models.Utility.LoadingDialog;
import com.fyp.smhs.Models.WebServices.RetrofitAPI;
import com.fyp.smhs.Models.WebServices.RetrofitClient;
import com.fyp.smhs.databinding.FragmentHomeBinding;
import com.fyp.smhs.databinding.FragmentLocatorBinding;
...
public class LocatorFragment extends Fragment implements OnMapReadyCallback,
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
       ...
       // FirebaseFirestore db = FirebaseFirestore.getInstance();
        //CollectionReference locationReference2  = db.collection("Places");
        locationReference = FirebaseDatabase.getInstance().getReference("Places");
      //  CollectionReference userLocationReference = db.collection("Users")
         //  .(firebaseAuth.getUid()).child("Saved Locations");
      //  CollectionReference userLocationReference2 =  db.collection("Users").document(firebaseAuth.getUid()).collection("Posts");
